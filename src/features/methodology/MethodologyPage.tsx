  ...
  return (
    <div className="page-stack pb-4">
      ...
      <section className="space-y-4">
        ...
        <h2 className="font-display max-w-4xl text-[2rem] leading-[1.15] tracking-tight text-foreground md:text-[2.35rem]">
          Built so a market trader, a student, and a mother can all{' '}
          <span className="text-brand-green">trust the same number.</span>
        </h2>
        <p className="max-w-3xl text-[15px] leading-relaxed text-muted">{methodologyIntro}</p>
      </section>

      <section className="rounded-card border border-border bg-surface-soft p-6 md:p-8">
      ...
      <section className="rounded-hero bg-brand-green p-6 text-white shadow-sm md:p-8">
        ...
        <div className="mt-5 grid gap-3 md:grid-cols-3">
          {audienceCards.map((card) => (
            <article
              key={card.title}
              className="rounded-card border border-white/10 bg-white/10 p-5 backdrop-blur-sm"
            >
      ...
      <section>
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-3">
          {testimonials.map((item) => (
            <article
              key={item.name}
              className="flex h-full flex-col rounded-card border border-border bg-surface p-5 shadow-sm"
            >
      ...
      <section>
        ...
        <div className="mt-3 rounded-card border border-border bg-surface p-6 shadow-sm md:p-8">
      ...
      <footer className="pt-2 text-center text-sm leading-relaxed text-brand-green">
        {methodologyFooter}
      </footer>
    </div>
  )
